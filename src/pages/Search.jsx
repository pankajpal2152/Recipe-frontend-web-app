...
const Search = () => {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`https://recipewebappbackend.vercel.app/api/items/`, {
                    params: { q: query }
                });
    ...
    return (
        <div className='px-6 lg:px-12 py-20'>
            ...
            <div className='bg-white md:max-w-3xl mx-auto p-4 rounded relative flex items-center'>
                ...
                <input className='outline-none w-full placeholder:text-[#1b2629]' type='search' name='query' placeholder='Search for recipes...' id='search' required='' value={query} onChange={handleSearch} />
